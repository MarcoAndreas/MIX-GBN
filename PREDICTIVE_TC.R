...
PREDICTIVE_TC <- function(mix_hybrid_new,data_con,data_con2){
...
OUT = GENERATE_PARA_LIST_TC(VEC,data_con,T_0,v,mu)

MEANS_LIST = OUT[[1]]
T_m_LIST   = OUT[[2]]
m_LIST     = OUT[[3]]

out = SAMPLE_PARAMETERS_TC(T_m_LIST, m_LIST, MEANS_LIST, a, v, mu, DAG, m)
